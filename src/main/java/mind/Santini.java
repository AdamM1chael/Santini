...
public class Santini {
	...
	private final static Logger logger = Logger.getLogger(Santini.class);
	...
	/**
	 * Instantiates a new instance of Santini's mind. It requires an API Key
	 ...
	 * Santini decides to sell and buy back.
	 *
